// app/dashboard/bookstores/new/page.tsx
'use client';
...
export default function NewBookstorePage() {
  ...
  const onSubmit = (e: FormEvent) => {
    ...
    startTransition(async () => {
      ...
      if (!res.ok) {
        setError(data.error ?? '書店の作成に失敗しました。');
        return;
      }

      // 作成した書店のダッシュボードにリダイレクト
      router.push(`/dashboard?bookstore=${data.bookstore.id}`);
    });
  };
